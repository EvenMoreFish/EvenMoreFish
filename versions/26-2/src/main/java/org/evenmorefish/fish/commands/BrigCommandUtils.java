package org.evenmorefish.fish.commands;
...
public class BrigCommandUtils {
    ...
    public static @NonNull List<Player> resolvePlayers(@NonNull CommandContext<CommandSourceStack> ctx, @Nullable PlayerSelectorArgumentResolver resolver) throws CommandSyntaxException {
        if (resolver == null) {
            return List.of();
        }

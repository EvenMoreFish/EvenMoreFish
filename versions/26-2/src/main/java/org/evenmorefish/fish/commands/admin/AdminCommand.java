package org.evenmorefish.fish.commands.admin;
...
import org.evenmorefish.fish.commands.admin.subcommand.BaitSubcommand;
import org.evenmorefish.fish.commands.admin.subcommand.ClearBaitsSubcommand;
import org.evenmorefish.fish.commands.admin.subcommand.CompetitionSubcommand;
import org.evenmorefish.fish.commands.admin.subcommand.CustomRodSubcommand;
import org.evenmorefish.fish.commands.admin.subcommand.DatabaseSubcommand;
import org.evenmorefish.fish.commands.admin.subcommand.DebugSubcommand;
import org.evenmorefish.fish.commands.admin.subcommand.FishSubcommand;
import org.evenmorefish.fish.commands.admin.subcommand.ListSubcommand;
import org.evenmorefish.fish.commands.admin.subcommand.RandomFishSubcommand;
    ...
    protected @NonNull ArgumentBuilder<CommandSourceStack, ?> rawItem() {
        return Commands.literal("rawItem")
            .executes(ctx -> {
                ...
                builder.clickEvent(ClickEvent.clickEvent(ClickEvent.Action.COPY_TO_CLIPBOARD, ClickEvent.Payload.string(handItemNbt)));

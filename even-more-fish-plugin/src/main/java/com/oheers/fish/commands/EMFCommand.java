...
public interface EMFCommand {

    default boolean isEconomyDisabled(CommandSender sender) {
    ...
    default boolean isEconomyEnabled(CommandSender sender) {
        return !isEconomyDisabled(sender);
    }

    default boolean isLogDbError(final CommandSender sender) {
    ...
    default String getPlayersVariable(List<Player> players) {
    ...
    default void listRewardTypes(@NonNull Audience audience) {
    ...
    default void listRequirementTypes(@NonNull Audience audience) {
        TextComponent.Builder builder = Component.text();
    ...
    default void listItemAddons(@NonNull Audience audience) {
        TextComponent.Builder builder = Component.text();
